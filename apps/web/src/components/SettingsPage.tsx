...
export type SettingsSection = 'appearance' | 'planning' | 'account' | 'repeat' | 'stats' | 'data' | 'ai' | 'about'
    ...
    <main className="shell settings-page">
      ...
      <section className="settings-workspace" aria-label="设置工作区">
        ...
        <div className="settings-content">
          ...
          {props.section === 'stats' && <StatsSection facts={props.statsFacts} focusMinutes={props.focusMinutes} />}
